...
public class BasicProgram : ShaderProgram
{
    ...
    : base( vshFileName, fshFileName )
    {
		...
		/*	
		Console.WriteLine(vshFileName);
		Console.WriteLine(fshFileName);
		*/
        setUniformID();
    ...
    public void setUniformID()
    {
		...
		idBrightness = this.FindUniform( "RateLight");
    }
	...
	public void SetRateLight(float Brightness)
	{
		if(idBrightness >= 0 && 0 <= Brightness && Brightness <= 1){
            this.SetUniformValue( idBrightness, Brightness);					
		}			
	}
