...
//        GameCtrlManager ctrlResMgr = GameCtrlManager.GetInstance();
//        if( trgObjType == 0 ){
//            trgObj    = ctrlResMgr.CtrlHobit.GetUseActorBaseObj( idx );
//        }
//        else {
...
//        }
    ...
    private void setPlaceTrgParam( int idx )
    {
        ...
        if( trgObjMax > 0 ){
            /// 敵
            if( trgObjType == 0 ){
                trgObjPos    = ctrlResMgr.CtrlHobit.GetPos( idx );
                trgObjRot.Y    = ctrlResMgr.CtrlHobit.GetRotY( idx );
            }
            else {
            }
            setPlaceTrgObj( idx );
    ...
    private void setTrgObjMove( Vector3 move )
    {
        ...
        /// 敵
        if( trgObjType == 0 ){
            ctrlResMgr.CtrlHobit.SetPlace( trgObjIdx, trgObjPos );
        }
        else {
        }
    }
...
///---------------------------------------------------------------------------
    ...
    public bool frameDeleteObj()
    {
        ...
        if( trgObjType == 0 ){
            ctrlResMgr.CtrlHobit.DeleteEntryEnemy( trgObjIdx );
            trgObjMax = ctrlResMgr.CtrlHobit.GetEntryNum();
        }
